      ...
      <table style="width: 100%;">
        <tr>
          ...
          <td style="padding: 20px; width: 70%;">
            ...
            <a href="https://www.organiknation.ca/" style="font-size:16px; line-height: 24px; color:#fff; text-decoration: none;">Website: www.organiknation.ca</a><br>
            <a href="mailto:info@organiknation.ca" style="font-size:16px; line-height: 24px; color:#fff; text-decoration: none;">Email: info@organiknation.ca</a><br>
            <a href="tel:14185704073" style="font-size:16px; color:#fff; line-height: 24px; text-decoration: none;">Phone: +1 (418) 570-4073</a>
          </td>
          <td style="width: 10%;">
